...
const Header = () => {
	...
	return (
		<>
			<header className='border-2 border-teal-800 h-[10vh] rounded-md my-5 mx-5 p-5 bg-slate-50 flex justify-between items-center'>
				<div className='relative cursor-pointer' onClick={handleClick}>
					...
					<i className='fa-regular fa-bell text-3xl text-gray-700 cursor-pointer'></i>
				</div>
